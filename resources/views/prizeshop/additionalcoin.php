    ...
    <div class="container-fluid py-4">
        <div class="row main-content">
            ...
            <form method="POST" action="{{ route('tambah-data') }}">
                ...
                <div class="form-group">
                    <label for="id_tenant">Tenant ID</label>
                ...
                <div class="form-group">
                    <label for="total_poin">Total Point</label>
                    <input type="text" name="total_poin" class="form-control" required>
                    @error('total_poin')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="admin_aksekutor" class="form-control" value="{{ $dataUser->name }}">
