...
class PrizeshopController extends Controller
{
    ...
    public function addData(Request $request){
        ...
        $user = DB::table('users')
            ->select('id', 'name', 'email', 'no_telp', 'ig', 'poin', 'jenis_kelamin')
            ->where('email', '=', $qrdata) // Replace with the email you're searching for
    ...
    public function addDataReward(Request $request){
        ...
        if ($user) {
            ...
            // Access user data
            return view('admin/addreward', compact('active','profile', 'remarks'));
